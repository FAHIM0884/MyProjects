...
$sql = "DELETE FROM add_dealers WHERE id='$bid'";
...
<section class="wthree-row py-5">
	<div class="container py-lg-5 py-sm-3">
		<h3 align="center" class="heading text-capitalize mb-sm-5 mb-4"> Manage Dealers </h3>
		<form name="form1" method="post" action="">
		  <table width="828" height="95" border="0" align="center">
            <tr>
              <td><div align="center"><strong>Dealer Name</strong></div></td>
              <td><div align="center"><strong>Company Name </strong></div></td>
              <td><div align="center"><strong>Contact</strong></div></td>
              <td><div align="center"><strong>Mail Id </strong></div></td>
              <td><div align="center"><strong>Address</strong></div></td>
              <td><div align="center"><strong>Edit/Remove</strong></div></td>
            </tr>
            <?php
					$qr1="select * from   add_dealers";
            ...
            <tr>
              ...
              <td><div align="center"><strong>
			  <a href="update_dealers.php?up=<?php echo $row['id'];?>">Edit</a>/ <a href="manage_dealers.php?act=ok&&up=<?php echo $row['id'];?>">Remove</a>
			  </strong></div></td>
            </tr>
            <?php
