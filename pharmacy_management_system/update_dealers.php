...
if ($conn->connect_error) {
 ...
 $qrys1="update  add_dealers set dealer_name='$name',company_name='$comp_name',contact='$contact',mail_id='$email',address='$address' where id='$bid'";
  if ($conn->query($qrys1) === TRUE) {
  ?>					
	<script language="javascript">
	alert("Update Dealers Success");
...
<section class="wthree-row py-5">
	<div class="container py-lg-5 py-sm-3">
		<h3 align="center" class="heading text-capitalize mb-sm-5 mb-4"> Update Dealers </h3>
		<form name="form1" method="post" action="">
		  <table width="406" height="478" border="0" align="center">

            <tr>
              <th scope="row">Name</th>
              <td><input name="name" type="text" id="name" class="hauf"></td>
            </tr>
            <tr>
              <th scope="row">Company Name </th>
              <td><label>
                <input name="comp_name" type="text" id="comp_name" class="hauf">
              </label></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><label>
                <input name="email" type="text" id="email" required class="hauf">
              </label></td>
            </tr>
            <tr>
              <th scope="row">Address</th>
              <td><input name="address" type="text" id="address" required class="hauf"></td>
            </tr>

            <tr>
              <th scope="row">&nbsp;</th>
              <td><label>
                <input name="btn" type="submit" id="btn" value="Update" onClick="return add_dealers()">
              </label></td>
            </tr>
          </table>
