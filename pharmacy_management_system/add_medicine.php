...
if ($conn->connect_error) {
 ...
 $qrys1="select id from  add_medicine ORDER BY id ASC";
...
$rdate=date("d-m-y");
 ...
 $qrys1="insert into  add_medicine values( $id,'$name','$type','$price','$quantity','$gst','$rdate')";
...
<section class="wthree-row py-5">
	<div class="container py-lg-5 py-sm-3">
		<h3 align="center" class="heading text-capitalize mb-sm-5 mb-4"> Add Medicine </h3>
		<form name="form1" method="post" action="">
		  <table width="406" height="478" border="0" align="center">
            ...
            <tr>
              ...
              <td><input name="type" type="text" id="type" required class="hauf"></td>
            </tr>
            ...
            <tr>
              <th scope="row">&nbsp;</th>
              <td><label>
                <input name="btn" type="submit" id="btn" value="ADD" onClick="return add_medicine()">
              </label></td>
            </tr>
          </table>
